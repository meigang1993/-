window.GameSkinData = (() => {
  ...
  const skins = [
    ...
    { id: "angelica_berserker", charId: "angelica", name: "帝血弑天", quality: "epic", price: 10, art: "./assets/generated/angelica-berserker.30dab19b.webp", dynamicEffect: "angelica-berserker", specialEffect: true, desc: "暗红血意凝成鳞甲与巨剑，竖瞳、裂纹光流和脊椎残影让安洁莉卡化作压向战场的狂战凶锋。" },
