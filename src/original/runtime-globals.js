(function installRuntimeGlobals() {
  ...
  const names = [
    ...
    "BattleDamageTriggers", "BattleDamageUtils", "BattleReactionQueue", "BattleCardResume", "BattleCardResumeFlow", "BattleCardResumeHooks", "BattleCardResumeState", "BattleDiscardFlow", "BattleDiscardOverflow", "BattleEndPhase",
