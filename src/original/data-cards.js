...
const eliteCardDefs = [
  ...
  { name: "勒杀", price: 1200, type: "slash", scale: "attack", strangleKill: true, suits: starterSuits, text: "指定一名敌方角色为目标，对其造成等同于你的攻击力的物理伤害。若此牌造成生命值伤害，目标获得不可叠加的“勒脖”标记（多段或连击伤害时，每段伤害后各结算一次。）。目标每个准备阶段受到X点物理伤害（X为你施加标记时攻击力的一半，向下取整且至少1点）。" },
