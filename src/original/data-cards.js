...
const eliteCardDefs = [
  ...
  { name: "机枪扫杀", price: 1000, type: "slash", scale: "attack", sweep: true, targetless: true, responseKind: "dodge", suits: starterSuits, text: "指定所有敌方角色为目标，对其各造成等同于你的攻击力的物理伤害。" },
