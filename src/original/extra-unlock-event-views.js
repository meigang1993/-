window.ExtraUnlockEventViews = (() => {
  ...
  function underwaterTrainUnlock(state) {
    ...
    const besta = state.chars.find(c => c.id === "besta") || { name: "贝丝妲", avatar: "./assets/images/besta-portrait.e6a6361b.webp" }, nanali = state.chars.find(c => c.id === "nanali"), aileng = state.chars.find(c => c.id === "aileng");
  ...
  function bestaNurseryUnlock(state) {
    ...
    const besta = state.chars.find(c => c.id === "besta") || { name: "贝丝妲", avatar: "./assets/images/besta-portrait.e6a6361b.webp" }, aileng = state.chars.find(c => c.id === "aileng");
