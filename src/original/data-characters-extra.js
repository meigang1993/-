window.GameDataCharactersExtra = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "狂战意志", type: "passive", icon: "⭐", text: "锁定技，当你造成或受到伤害后，你获得1枚“狂战”标记（多段或连击伤害时，每段伤害后各结算一次。）。你使用实体【杀】牌时，可弃1枚“狂战”标记代替1点杀意消耗。“狂战”标记数量在头像旁以“狂战×N”显示，上限为10枚。" },
  ...
  },
  {
    ...
    skills: [
      { name: "毒针", type: "passive", icon: "⭐", text: "锁定技，当你使用【杀】造成生命值伤害后，目标获得1枚“毒”标记（多段或连击伤害时，每段伤害后各结算一次。）。拥有“毒”标记的角色回合开始时，受到等同于其“毒”标记数的毒属性伤害。" },
