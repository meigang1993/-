window.GameDataCharactersCore = [
  ...
  },
  {
    ...
    skills: [
      { name: "神速之袭", type: "active", icon: "⚔️", text: "准备阶段和结束阶段各限一次，你可以指定一名敌方角色，视为对其使用1张虚拟【刺杀】；准备阶段发动时跳过本回合的判定阶段和摸牌阶段，结束阶段发动后你翻面。若此次伤害令目标死亡，你摸X张牌（X为你的初始摸牌数）。", card: { name: "神速之袭", type: "tactic", speedAssault: true, icon: "⚔️", text: "准备阶段和结束阶段各限一次，指定一名敌方角色并视为对其使用虚拟【刺杀】；准备阶段发动时跳过判定和摸牌，结束阶段发动后你翻面。" } },
