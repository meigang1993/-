window.GameDataCharactersCore = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "锁魂镰刀", type: "passive", text: "锁定技，当你使用实体单体【杀】造成生命值伤害后，你对所有存活的敌方角色各造成等同于你魔力的无视护甲伤害。若有角色因此死亡，重复此效果，至多重复4次（虚拟【杀】不触发）。" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "神速之翼", type: "passive", icon: "⭐", text: "锁定技，当你成为需用【闪】抵消的牌的目标时（含【杀】与机枪扫杀、坦克炮弹等需用【闪】抵消的牌），你将1张手牌当【闪】使用。" },
