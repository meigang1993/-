window.GameDataNewCharacters = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "蓄力子弹", type: "passive", icon: "⭐", text: "本回合首次使用每种花色的牌时记录花色。下一张实体单体【杀】伤害×（1+记录花色数）：记录1种×2、2种×3、3种×4、4种×5，使用后清除记录。" },
    ],
  },
  {
    ...
    skills: [
      { name: "神数咒语", type: "passive", icon: "⭐", text: "锁定技，出牌阶段，你每使用一张牌便获得一枚神数标记；每有一枚神数标记，你的攻击力和魔力各+1。当你累计使用的牌数达到1张、3张、6张时，你分别摸1张、2张、3张牌。回合结束时移去所有神数标记。角色头像显示的数字为「使用牌目标数」：回合开始为1，每使用一张牌便+1（使用1张后为2、使用2张后为3，以此类推）。" },
      { name: "荣誉祝福", type: "active", icon: "⚔️", text: "出牌阶段限一次，你可以弃置1至4张花色各不相同的牌。我方全体角色根据你的攻击力、魔力、速度分别获得等量属性提升，持续弃置牌数个回合。你的角色头像上显示本次弃置的花色，每回合消失一个花色；只要仍拥有花色，荣誉祝福就无法再次发动。", card: { name: "荣誉祝福", type: "tactic", mariaHonorBlessing: true, icon: "⚔️", text: "选择1至4张花色各不相同的手牌弃置。" } },
    ],
  },
];
