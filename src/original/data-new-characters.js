window.GameDataNewCharacters = [
  {
    ...
    gender: "female",
    face: "格",
    art: "./assets/new-portraits/gerda.ddb6449d.webp",
    avatar: "./assets/new-portraits/gerda.ddb6449d.webp",
    role: "兽人公主",
    locked: true,
    unlockCost: 20,
  ...
  },
  {
    ...
    gender: "female",
    face: "依",
    art: "./assets/new-portraits/hoshino-yi.3b9812bf.webp",
    avatar: "./assets/new-portraits/hoshino-yi.3b9812bf.webp",
    role: "XX型凋零者",
    locked: true,
    mother: "混沌女神",
    sourceDungeon: "兽人地下城",
  ...
  },
  {
    ...
    gender: "male",
    face: "海",
    art: "./assets/new-portraits/hoshino-kaiichi.b7ab4193.webp",
    avatar: "./assets/new-portraits/hoshino-kaiichi.b7ab4193.webp",
    role: "艾伦格私生子",
    locked: true,
    mother: "星野依（已过世）",
    father: "艾伦格",
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "荣誉祝福", type: "active", icon: "⚔️", text: "出牌阶段限一次，你可以弃置1至4张花色各不相同的手牌，令我方全体角色的攻击力、魔力、速度各+你当前的攻击力、魔力、速度（含神数咒语等临时加成），并记录这些花色。每回合结束时，我方每名角色弃去其中一种花色；当一名角色的花色全部弃去后，其因此获得的属性提升失效。只要你的花色未全部弃去，你便不能再次发动荣誉祝福。", card: { name: "荣誉祝福", type: "tactic", mariaHonorBlessing: true, icon: "⚔️", text: "弃置1至4张花色各不相同的手牌。" } },
    ],
  },
];
