window.GameDataNewCharacters = [
  ...
  },
  {
    ...
    skills: [
      { name: "神数咒语", type: "passive", icon: "⭐", text: "锁定技，出牌阶段，你每使用一张牌便获得一枚神数标记；每有一枚神数标记，你的攻击力和魔力各+1。当你本阶段使用的牌数达到目标数时，你摸与目标数等量的牌，然后将使用的牌数重新计数、神数标记清零，并使目标数+1。回合结束时移去所有神数标记。" },
      { name: "荣誉祝福", type: "active", icon: "⚔️", text: "出牌阶段限一次，你可以弃置1至4张花色各不相同的牌。我方全体角色根据你的攻击力、魔力、速度分别获得等量属性提升。我方全体角色每回合消失一个花色；某名角色的花色全部消失后，其获得的属性提升随之失效。只要玛利亚仍拥有花色，荣誉祝福就无法再次发动。", card: { name: "荣誉祝福", type: "tactic", mariaHonorBlessing: true, icon: "⚔️", text: "选择1至4张花色各不相同的手牌弃置。" } },
    ],
  },
];
