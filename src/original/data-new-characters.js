window.GameDataNewCharacters = [
  ...
  },
  {
    ...
    skills: [
      { name: "狙击目标", type: "active", icon: "⚔️", text: "出牌阶段限一次，你可以选择一名敌方角色，展示其一张手牌。若你手牌中与此牌花色相同的牌数多于该角色，则你对其使用的实体单体【杀】不可被响应。", card: { name: "狙击目标", type: "tactic", artinaSniper: true, enemyTarget: true, artName: "狙击目标", icon: "⚔️", text: "选择一名敌方角色，展示其一张手牌。" } },
      { name: "蓄力子弹", type: "passive", icon: "⭐", text: "锁定技，每回合你首次使用一种花色的牌时，你记录该花色。你使用的下一张实体单体【杀】伤害×（1+你已记录的花色数）：记录1种为×2，2种为×3，3种为×4，4种为×5；此【杀】结算后，你清除所有记录。" },
    ],
  },
  {
    ...
    skills: [
      { name: "神数咒语", type: "passive", icon: "⭐", text: "锁定技，出牌阶段，你每使用一张牌，便获得1枚“神数”标记，且你的攻击力与魔力各+X（X为你“神数”标记的数量）。当你本阶段使用的牌数达到目标数时，你摸与目标数等量的牌，然后将已使用的牌数清零、弃去所有“神数”标记，并令目标数+1。回合结束时，你弃去所有“神数”标记。" },
      { name: "荣誉祝福", type: "active", icon: "⚔️", text: "出牌阶段限一次，你可以弃置1至4张花色各不相同的手牌，令我方全体角色的攻击力、魔力、速度各+你的攻击力、魔力、速度。每回合结束时，我方每名角色弃去其中一种花色；当一名角色的花色全部弃去后，其因此获得的属性提升失效。只要你的花色未全部弃去，你便不能再次发动荣誉祝福。", card: { name: "荣誉祝福", type: "tactic", mariaHonorBlessing: true, icon: "⚔️", text: "弃置1至4张花色各不相同的手牌。" } },
    ],
  },
];
